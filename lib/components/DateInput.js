...
var _componentPropType = _interopRequireDefault(require("../utils/componentPropType"));

var _getRenderComponent = _interopRequireDefault(require("../utils/getRenderComponent"));
...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)(_objectSpread({}, _reactWithStyles.withStylesPropTypes, {
  component: _componentPropType["default"],
...
function (_ref) {
  ...
  _proto.render = function render() {
    ...
    var Input = (0, _getRenderComponent["default"])(component);
